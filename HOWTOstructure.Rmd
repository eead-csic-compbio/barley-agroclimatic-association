...
After transposing [*SBCC_9K_SNPs.structure.tsv*](./SBCC_9K_SNPs.structure.tsv), Structure v2.3.4 was run 
under an admixture model, from K=1 to K=6. This was replicated 6x with a burn-in period of 15,000 and 20,000 Monte Carlo Markov Chain (MCMC) iterations, respectively. Evanno Delta K was used to estimate the optimal number of subpopulations,
...
[SBCC_Kinship.full.tsv](raw/SBCC_Kinship.full.tsv).
