...
void sylvester(double *A, double *B, double *C, double *X, int M, int N)
{
        ...
        dtrsyl_(&trana, &tranb, (integer *) (&isgn), (integer *) (&m),
                (integer *) (&n), (doublereal *) A, (integer *) (&m),
                (doublereal *) B, (integer *) (&n), (doublereal *) C,
                (integer *) (&m), (doublereal *) (&scale), (integer *) (&info));
...
void schur(double *A, double *Q, int M)
{
        ...
        dgees_(&jobsv, &sort, 0, (integer *) (&n), (doublereal *) A,
               ...
               (doublereal *) wi, (doublereal *) Q, (integer *) (&n),
               (doublereal *) work, (integer *) (&lwork), 0,
               (integer *) (&info));
