       ...
       Parameter adjustments */
        ...
        extern /* Subroutine */ int dlaqr2_(logical *, logical *, integer *,
            ...
            dlanv2_(doublereal *, doublereal *, doublereal *, doublereal *,
                    ...
                    doublereal *, doublereal *), dlaqr5_(logical *, logical *,
                                                         integer *, integer *,
                                                         integer *, integer *,
                                                         integer *,
                                                         doublereal *,
...
/*        ==== NWR = recommended deflation window size.  At this   
          ...
          .    NWR.GE.3.) ==== */
                ...
                nwr =
                    ilaenv_(&c__13, "DLAQR4", jbcmpz, n, ilo, ihi, lwork,
                            (ftnlen) 6, (ftnlen) 2);
                nwr = max(2, nwr);
/* Computing MIN */
...
/*        ==== NSR = recommended number of simultaneous shifts.   
          ...
          .    and greater than or equal to two as required. ==== */
                ...
                nsr =
                    ilaenv_(&c__15, "DLAQR4", jbcmpz, n, ilo, ihi, lwork,
                            (ftnlen) 6, (ftnlen) 2);
/* Computing MIN */
...
/*        ==== Estimate optimal workspace ====   
          ...
          ==== Workspace query call to DLAQR2 ==== */
                ...
                i__1 = nwr + 1;
                dlaqr2_(wantt, wantz, n, ilo, ihi, &i__1, &h__[h_offset], ldh,
...
/*        ==== DLAHQR/DLAQR0 crossover point ==== */
                ...
                nmin =
                    ilaenv_(&c__12, "DLAQR4", jbcmpz, n, ilo, ihi, lwork,
                            (ftnlen)
                            6, (ftnlen) 2);
                nmin = max(11, nmin);
...
/*        ==== Nibble crossover point ==== */
                ...
                nibble =
                    ilaenv_(&c__14, "DLAQR4", jbcmpz, n, ilo, ihi, lwork,
                            (ftnlen) 6, (ftnlen) 2);
                nibble = max(0, nibble);
...
/*        ==== Accumulate reflections during ttswp?  Use block   
          .    2-by-2 structure during matrix-matrix multiply? ==== */
                ...
                kacc22 =
                    ilaenv_(&c__16, "DLAQR4", jbcmpz, n, ilo, ihi, lwork,
                            (ftnlen) 6, (ftnlen) 2);
                kacc22 = max(0, kacc22);
                kacc22 = min(2, kacc22);
...
/*           ==== Aggressive early deflation ==== */
                        ...
                        dlaqr2_(wantt, wantz, n, &ktop, &kbot, &nw,
