...
/*  -- LAPACK computational routine (version 3.1) --   
    ...
    =====================================================================   
       ...
       Parameter adjustments */
        ...
        extern /* Subroutine */ int dlarrj_(integer *, doublereal *,
                                            doublereal *,
        ...
        extern doublereal dlanst_(char *, integer *, doublereal *,
                                  doublereal *);
        extern /* Subroutine */ int dlarrr_(integer *, doublereal *,
                                            doublereal *,
                                            integer *), dlarrv_(integer *,
                                                                doublereal *,
                                                                doublereal *,
                                                                doublereal *,
                                                                doublereal *,
...
/* Computing MIN */
        ...
        if (*info == 0) {
                ...
                if (wantz && alleig) {
                        ...
                        dlarrc_("T", n, vl, vu, &d__[1], &e[1], &safmin,
...
/*        Compute the desired eigenvectors corresponding to the computed   
          eigenvalues */
                ...
                dlarrv_(n, &wl, &wu, &d__[1], &e[1], &pivmin, &iwork[iinspl], m,
                        ...
                        &work[indgrs], &z__[z_offset], ldz, &isuppz[1],
...
/*           check if any eigenvalues have to be refined in this block */
 L36:
                        ...
                        rtol2 = eps * 4.;
                        dlarrj_(&in, &work[indd + ibegin - 1],
                                &work[inde2 + ibegin - 1], &ifirst, &ilast,
                                &rtol2, &offset, &w[wbegin],
                                &work[inderr + wbegin - 1], &work[indwrk],
