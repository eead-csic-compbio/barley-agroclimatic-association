                            ...
                            logical * bwork, integer * info)
{
        ...
        extern /* Subroutine */ int dorghr_(integer *, integer *, integer *,
            ...
            dhseqr_(char *, char *, integer *, integer *, integer *,
                    ...
                    integer *), dtrsen_(char *, char *, logical *, integer *,
...
/*       the worst case.) */
        ...
        if (*info == 0) {
                if (*n == 0) {
                        ...
                        maxwrk =
                            (*n << 1) + *n * ilaenv_(&c__1, "DGEHRD", " ", n,
                                                     &c__1, n, &c__0);
                        minwrk = *n * 3;

                        dhseqr_("S", jobvs, n, &c__1, n, &a[a_offset], lda,
                                &wr[1], &wi[1]
                                , &vs[vs_offset], ldvs, &work[1], &c_n1,
                                &ieval);
...
/*     Scale A if max element outside range [SMLNUM,BIGNUM] */
        ...
        if (scalea) {
                dlascl_("G", &c__0, &c__0, &anrm, &cscale, n, n, &a[a_offset],
                        lda, &ierr);
        }
...
/*     (Workspace: need 3*N, prefer 2*N+N*NB) */
        ...
        iwrk = *n + itau;
        i__1 = *lwork - iwrk + 1;
        dgehrd_(n, &ilo, &ihi, &a[a_offset], lda, &work[itau], &work[iwrk],
                &i__1, &ierr);
...
/*        (Workspace: need 3*N-1, prefer 2*N+(N-1)*NB) */
                ...
                i__1 = *lwork - iwrk + 1;
                dorghr_(n, &ilo, &ihi, &vs[vs_offset], ldvs, &work[itau],
                        &work[iwrk], &i__1, &ierr);
        }
...
/*     (Workspace: need N+1, prefer N+HSWORK (see comments) ) */
        ...
        iwrk = itau;
        i__1 = *lwork - iwrk + 1;
        dhseqr_("S", jobvs, n, &ilo, &ihi, &a[a_offset], lda, &wr[1], &wi[1],
                &vs[vs_offset], ldvs, &work[iwrk], &i__1, &ieval);
        if (ieval > 0) {
                *info = ieval;
        }
...
/*     Sort eigenvalues if desired */
        ...
        if (wantst && *info == 0) {
                if (scalea) {
                        dlascl_("G", &c__0, &c__0, &cscale, &anrm, n, &c__1,
                                &wr[1], n, &ierr);
                        dlascl_("G", &c__0, &c__0, &cscale, &anrm, n, &c__1,
                                &wi[1], n, &ierr);
                }
...
/*        (Workspace: none needed) */
                ...
                i__1 = *lwork - iwrk + 1;
                dtrsen_("N", jobvs, &bwork[1], n, &a[a_offset], lda,
                        &vs[vs_offset], ldvs, &wr[1], &wi[1], sdim, &s, &sep,
                        &work[iwrk], &i__1, idum, &c__1, &icond);
                if (icond > 0) {
                        *info = *n + icond;
                }
        }
...
/*        (Workspace: need N) */
                ...
                dgebak_("P", "R", n, &ilo, &ihi, &work[ibal], n, &vs[vs_offset],
                        ldvs, &ierr);
        }
...
/*        Undo scaling for the Schur form of A */
                ...
                dlascl_("H", &c__0, &c__0, &cscale, &anrm, n, n, &a[a_offset],
                        lda, &ierr);
                i__1 = *lda + 1;
...
/* Computing MAX */
                                i__3 = ilo - 1;
                                i__2 = max(i__3, 1);
                                dlascl_("G", &c__0, &c__0, &cscale, &anrm,
                                        &i__1, &c__1, &wi[1], &i__2, &ierr);
                        } else if (wantst) {
                                i1 = 1;
                                i2 = *n - 1;
                        } else {
...
/* Computing MAX */
                i__3 = *n - ieval;
                i__2 = max(i__3, 1);
                dlascl_("G", &c__0, &c__0, &cscale, &anrm, &i__1, &c__1,
                        &wi[ieval + 1], &i__2, &ierr);
        }
