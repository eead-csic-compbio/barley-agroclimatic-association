...
/*           to annihilate A(1:i-1,i+1) */
                        ...
                        dlarfg_(&i__, &a[i__ + (i__ + 1) * a_dim1],
                                &a[(i__ + 1) * a_dim1 + 1], &c__1, &taui);
...
/*              Compute  x := tau * A * v  storing x in TAU(1:i) */
                                ...
                                dsymv_(uplo, &i__, &taui, &a[a_offset], lda,
                                       &a[(i__ + 1) * a_dim1 + 1], &c__1, &c_b8,
                                       &tau[1], &c__1);

/*              Compute  w := x - 1/2 * tau * (x'*v) * v */

                                alpha =
                                    taui * -.5 * ddot_(&i__, &tau[1], &c__1,
                                                       &a[(i__ + 1)
                                                          * a_dim1 + 1], &c__1);
                                daxpy_(&i__, &alpha, &a[(i__ + 1) * a_dim1 + 1],
                                       &c__1, &tau[1], &c__1);

/*              Apply the transformation as a rank-2 update: */
/*                 A := A - v * w' - w * v' */

                                dsyr2_(uplo, &i__, &c_b14,
...
/* Computing MIN */
                        ...
                        dlarfg_(&i__2, &a[i__ + 1 + i__ * a_dim1],
                                &a[min(i__3, *n) + i__ * a_dim1], &c__1, &taui);
...
/*              Compute  x := tau * A * v  storing y in TAU(i:n-1) */
                                ...
                                i__2 = *n - i__;
                                dsymv_(uplo, &i__2, &taui,
                                       &a[i__ + 1 + (i__ + 1) * a_dim1], lda,
                                       &a[i__ + 1 + i__ * a_dim1], &c__1, &c_b8,
                                       &tau[i__], &c__1);
...
/*              Compute  w := x - 1/2 * tau * (x'*v) * v */
                                ...
                                i__2 = *n - i__;
                                alpha =
                                    taui * -.5 * ddot_(&i__2, &tau[i__], &c__1,
                                                       &a[i__ + 1 +
                                                          i__ * a_dim1], &c__1);
                                i__2 = *n - i__;
                                daxpy_(&i__2, &alpha,
