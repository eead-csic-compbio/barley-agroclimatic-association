...
/*  -- LAPACK auxiliary routine (version 3.1) --   
       ...
       Parameter adjustments */
        ...
        extern /* Subroutine */ int dlanv2_(doublereal *, doublereal *,
                                            ...
                                            doublereal *, doublereal *,
                                            doublereal *, doublereal *),
            dlaqr3_(logical *, logical *, integer *, integer *, integer *,
                    integer *, doublereal *, integer *, integer *, integer *,
                    doublereal *, integer *, integer *, integer *, doublereal *,
                    doublereal *, doublereal *, integer *, integer *,
                    doublereal *, integer *, integer *, doublereal *, integer *,
                    doublereal *, integer *), dlaqr4_(logical *, logical *,
                                                      integer *, integer *,
                                                      integer *, doublereal *,
                                                      integer *, doublereal *,
                                                      doublereal *, integer *,
                                                      ...
                                                      integer *, doublereal *,
                                                      integer *, integer *),
            dlaqr5_(logical *, logical *, integer *, integer *, integer *,
...
/*        ==== Estimate optimal workspace. ==== */
                ...
                lwkopt = 1;
                if (*lwork != -1) {
                        dlahqr_(wantt, wantz, n, ilo, ihi, &h__[h_offset], ldh,
                                &wr[1], &wi[1], iloz, ihiz, &z__[z_offset], ldz,
                                info);
                }
        } else {
...
/*        ==== NWR = recommended deflation window size.  At this   
          ...
          .    NWR.GE.3.) ==== */
                ...
                nwr =
                    ilaenv_(&c__13, "DLAQR0", jbcmpz, n, ilo, ihi, lwork,
                            (ftnlen) 6, (ftnlen) 1);
                nwr = max(2, nwr);
/* Computing MIN */
                i__1 = *ihi - *ilo + 1, i__2 = (*n - 1) / 3, i__1 =
                    min(i__1, i__2);
                nwr = min(i__1, nwr);
                nw = nwr;
...
/*        ==== NSR = recommended number of simultaneous shifts.   
          ...
          .    and greater than or equal to two as required. ==== */
                ...
                nsr =
                    ilaenv_(&c__15, "DLAQR0", jbcmpz, n, ilo, ihi, lwork,
                            (ftnlen) 6, (ftnlen) 1);
/* Computing MIN */
                i__1 = nsr, i__2 = (*n + 6) / 9, i__1 = min(i__1, i__2), i__2 =
                    *ihi - *ilo;
                nsr = min(i__1, i__2);
/* Computing MAX */
...
/*        ==== Estimate optimal workspace ====   
          ...
          ==== Workspace query call to DLAQR3 ==== */
                ...
                i__1 = nwr + 1;
                dlaqr3_(wantt, wantz, n, ilo, ihi, &i__1, &h__[h_offset], ldh,
                        iloz, ihiz, &z__[z_offset], ldz, &ls, &ld, &wr[1],
                        &wi[1], &h__[h_offset], ldh, n, &h__[h_offset], ldh, n,
...
/*        ==== DLAHQR/DLAQR0 crossover point ==== */
                ...
                nmin =
                    ilaenv_(&c__12, "DLAQR0", jbcmpz, n, ilo, ihi, lwork,
                            (ftnlen) 6, (ftnlen) 1);
                nmin = max(11, nmin);
...
/*        ==== Nibble crossover point ==== */
                ...
                nibble =
                    ilaenv_(&c__14, "DLAQR0", jbcmpz, n, ilo, ihi, lwork,
                            (ftnlen) 6, (ftnlen) 1);
                nibble = max(0, nibble);
...
/*        ==== Accumulate reflections during ttswp?  Use block   
          .    2-by-2 structure during matrix-matrix multiply? ==== */
                ...
                kacc22 =
                    ilaenv_(&c__16, "DLAQR0", jbcmpz, n, ilo, ihi, lwork,
                            (ftnlen) 6, (ftnlen) 1);
                kacc22 = max(0, kacc22);
                kacc22 = min(2, kacc22);
...
/*           ==== Aggressive early deflation ==== */
                        ...
                        dlaqr3_(wantt, wantz, n, &ktop, &kbot, &nw,
                                &h__[h_offset], ldh, iloz, ihiz, &z__[z_offset],
                                ldz, &ls, &ld, &wr[1], &wi[1],
                                &h__[kv + h_dim1], ldh, &nho,
                                &h__[kv + kt * h_dim1], ldh, &nve,
...
/*              ==== Small-bulge multi-shift QR sweep ==== */
                                ...
                                dlaqr5_(wantt, wantz, &kacc22, n, &ktop, &kbot,
                                        &ns, &wr[ks], &wi[ks], &h__[h_offset],
                                        ldh, iloz, ihiz, &z__[z_offset], ldz,
                                        &work[1], &c__3, &h__[ku + h_dim1], ldh,
                                        &nve, &h__[kwv + h_dim1], ldh, &nho,
