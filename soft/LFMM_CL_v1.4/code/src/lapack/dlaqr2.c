...
/*     ==== Convert to spike-triangular form.  (In case of a   
       ...
       .    here and there to keep track.) ==== */
        ...
        dlahqr_(&c_true, &c_true, &jw, &c__1, &jw, &t[t_offset], ldt,
                &sr[kwtop], &si[kwtop], &c__1, &jw, &v[v_offset], ldv, &infqr);
...
/*           ==== Reflect spike back into lower triangle ==== */
                        ...
                        i__1 = jw - 2;
                        i__2 = jw - 2;
                        dlaset_("L", &i__1, &i__2, &c_b10, &c_b10,
                                &t[t_dim1 + 3], ldt);
          ...
          .    marginally more efficient than the following.) ==== */
                ...
                if (*ns > 1 && s != 0.) {
                        ...
                        dorghr_(&jw, &c__1, ns, &t[t_offset], ldt, &work[1],
                                &work[jw + 1]
                                , &i__1, &info);
                        dgemm_("N", "N", &jw, ns, ns, &c_b11, &v[v_offset], ldv,
                               &t[t_offset], ldt, &c_b10, &wv[wv_offset], ldwv);
...
/* Computing MIN */
                        ...
                        kln = min(i__3, i__4);
                        dgemm_("N", "N", &kln, &jw, &jw, &c_b11,
                               &h__[krow + kwtop * h_dim1], ldh, &v[v_offset],
                               ldv, &c_b10, &wv[wv_offset], ldwv);
...
/* Computing MIN */
                                ...
                                kln = min(i__3, i__4);
                                dgemm_("C", "N", &jw, &kln, &jw, &c_b11,
                                       &v[v_offset], ldv,
                                       &h__[kwtop + kcol * h_dim1], ldh, &c_b10,
                                       &t[t_offset], ldt);
