...
/*  -- LAPACK auxiliary routine (version 3.1) --   
   ...
   =====================================================================   
       ...
       Parameter adjustments */
        ...
        integer b_dim1, b_offset, tl_dim1, tl_offset, tr_dim1, tr_offset,
            x_dim1, x_offset;
...
/* L70: */
                ...
                if (ipsv != i__) {
                        dswap_(&c__4, &t16[ipsv - 1], &c__4, &t16[i__ - 1],
                               &c__4);
                        temp = btmp[i__ - 1];
