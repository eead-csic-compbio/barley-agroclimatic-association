...
/* Subroutine */ int dlarrv_(integer * n, doublereal * vl, doublereal * vu,
                             doublereal * d__, doublereal * l,
                             doublereal * pivmin, integer * isplit, integer * m,
                             integer * dol, integer * dou, doublereal * minrgp,
                             doublereal * rtol1, doublereal * rtol2,
                             doublereal * w, doublereal * werr,
                             doublereal * wgap, integer * iblock,
                             integer * indexw, doublereal * gers,
                             ...
                             doublereal * work, integer * iwork, integer * info)
{
        ...
        extern /* Subroutine */ int dlarrb_(integer *, doublereal *,
                                            doublereal *,
        ...
        doublereal spdiam;
        integer negcnt;
        extern /* Subroutine */ int dlarrf_(integer *, doublereal *,
                                            doublereal *,
                                            doublereal *, integer *, integer *,
                                            doublereal *, doublereal *,
                                            doublereal *, doublereal *,
...
/*     The width of the part of Z that is used */
        ...
        dlaset_("Full", n, &zusedw, &c_b5, &c_b5, &z__[zusedl * z_dim1 + 1],
                ldz);
...
/*                       Get representation from the right end of Z array */
                                        ...
                                        dcopy_(&in, &z__[ibegin + j * z_dim1],
                                               &c__1, &d__[ibegin]
                                               , &c__1);
                                        i__3 = in - 1;
                                        dcopy_(&i__3,
                                               &z__[ibegin + (j + 1) * z_dim1],
                                               &c__1, &l[ibegin], &c__1);
                                        sigma = z__[iend + (j + 1) * z_dim1];
/*                 Set the corresponding entries in Z to zero */
                                        dlaset_("Full", &in, &c__2, &c_b5,
                                                &c_b5,
...
/*                 eigenvalues to the precision needed. */
                                        dlarrb_(&in, &d__[ibegin],
                                                &work[indlld + ibegin - 1], &p,
                                                &q, rtol1, rtol2, &offset,
