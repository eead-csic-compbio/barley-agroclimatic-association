...
/*  -- LAPACK routine (version 3.1) --   
    ...
    =====================================================================   
       ...
       Parameter adjustments */
        ...
        extern /* Subroutine */ int dorm2r_(char *, char *, integer *,
                                            integer *,
...
/*        Determine the block size.  NB may be at most NBMAX, where NBMAX   
   ...
   Writing concatenation */
                ...
                i__1 = 64, i__2 =
                    ilaenv_(&c__1, "DORMQR", ch__1, m, n, k, &c_n1, (ftnlen) 6,
                            (ftnlen) 2);
                nb = min(i__1, i__2);
                lwkopt = max(1, nw) * nb;
...
/* Computing MAX   
   Writing concatenation */
                        ...
                        s_cat(ch__1, a__1, i__3, &c__2, (ftnlen) 2);
                        i__1 = 2, i__2 =
                            ilaenv_(&c__2, "DORMQR", ch__1, m, n, k, &c_n1,
                                    (ftnlen) 6, (ftnlen) 2);
                        nbmin = max(i__1, i__2);
                }
        } else {
...
/*        Use unblocked code */
                ...
                dorm2r_(side, trans, m, n, k, &a[a_offset], lda, &tau[1],
...
/*           Form the triangular factor of the block reflector   
             H = H(i) H(i+1) . . . H(i+ib-1) */
                        ...
                        i__4 = nq - i__ + 1;
                        dlarft_("Forward", "Columnwise", &i__4, &ib,
                                &a[i__ + i__ * a_dim1], lda, &tau[i__], t,
                                &c__65);
                        if (left) {
...
/*           Apply H or H' */
                        ...
                        dlarfb_(side, trans, "Forward", "Columnwise", &mi, &ni,
                                &ib, &a[i__ + i__ * a_dim1], lda, t, &c__65,
