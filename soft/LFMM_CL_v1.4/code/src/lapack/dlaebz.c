...
/* Subroutine */ int dlaebz_(integer * ijob, integer * nitmax, integer * n,
                             ...
                             doublereal * pivmin, doublereal * d__,
                             doublereal * e, doublereal * e2, integer * nval,
                             doublereal * ab, doublereal * c__, integer * mout,
                             integer * nab, doublereal * work, integer * iwork,
                             integer * info)
{
        /* System generated locals */
        integer nab_dim1, nab_offset, ab_dim1, ab_offset, i__1, i__2, i__3,
            i__4, i__5, i__6;
...
/*        Check for convergence */
                ...
                for (ji = kf; ji <= i__2; ++ji) {
                        tmp1 = (d__1 =
                                ab_ref(ji, 2) - ab_ref(ji, 1), abs(d__1));
/* Computing MAX */
                        d__3 = (d__1 = ab_ref(ji, 2), abs(d__1)), d__4 = (d__2 =
                                                                          ab_ref
                                                                          (ji,
                                                                           1),
                                                                          abs
